            ...
            <div className="w-full max-w-md">
              <div className="relative rounded-[3rem] p-[2px] bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 shadow-[0_0_60px_rgba(0,255,255,0.3)]">
                <div className="rounded-[3rem] bg-[#0f1117] p-10">
                  <h2 className="text-3xl text-center mb-8">Login to Your Account</h2>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <Button
                      type="submit"
                      className="w-full h-12 bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-400 hover:to-purple-500 text-white rounded-full transition-all hover:scale-105 shadow-lg hover:shadow-cyan-500/50"
                    >
                      LOGIN
                    </Button>
                  </form>

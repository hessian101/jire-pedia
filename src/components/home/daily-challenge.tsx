    ...
    <div className="relative rounded-2xl border border-cyan-500/30 bg-[#1a1d2e]/50 overflow-hidden shadow-[0_0_30px_rgba(0,255,255,0.1)]">
      ...
      <div className="relative z-10 p-12 text-center space-y-6">
        <div className="space-y-2">
          ...
          <h2 className="text-5xl font-bold">光合成</h2>
        ...
        <Link
          href="/play/select"
          className="inline-block px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-white rounded-full transition-all hover:scale-105 shadow-lg hover:shadow-cyan-500/50 font-medium"
        >
          挑戦を開始
        </Link>
      </div>
